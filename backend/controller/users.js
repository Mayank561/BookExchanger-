...
exports.signUp = async (req, res) => {
  ...
  try {
    ...
    updatedUser.save();
    const sender = "reply.bookchanger@gmail.com";
    const subject = "Bookchanger Verify Email";
    const body =
...
exports.sendResetPassEmail = async (req, res) => {
  ...
  try {
    ...
    const sender = "reply.bookchanger@gmail.com";
    const subject = "Bookchanger Password Reset";
    const body =
      "You are receiving this because you (or someone else) have requested the reset of the password for your account.\n\n" +
      "Please click on the following link, or paste this into your browser to complete the process:\n\n" +
      req.headers.origin +
...
exports.sendMail = async (req, res) => {
  ...
  try {
    ...
    const receiver = "bookchanger7@gmail.com";
    ...
    const transporter = nodemailer.createTransport({
      ...
      requireTLS: true,
      auth: {
        user: "reply.bookchanger@gmail.com",
        pass: "Book@123123",
      },
    });

    const mailOptions = {
      from: "reply.bookchanger@gmail.com",
      to: receiver,
      subject: subject,
      text: message,
    };
